...
void matrixExtractionT_interp(const float T_interp[4][4][7][30], int index, float T_P2[4][4][7]);
...
void SLERP_interpolation(const float T_P1[4][4][7], const float T_P2[4][4][7], int points_num, float T_interp[4][4][7][30]);
...
void InverseKinematics_Modified(const float a[], const float d[], const float T_interp[4][4][7][30], int index, 
                         const float q_actual[7], float q_out[7]);
